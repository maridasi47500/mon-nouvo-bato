...
class Route():
    ...
    def gettasks(self,route):
        print("ok")
        items=self.dbTask.getall()
        item=random.choice(items) 
        print(item)
        self.render_figure.set_param("item",item)
        return self.render_some_json("welcome/task.json")
    def gettips(self,route):
        print("ok")
        items=self.dbTip.getall()
        item=random.choice(items) 
        print(item)
        self.render_figure.set_param("item",item)
        return self.render_some_json("welcome/task.json")
